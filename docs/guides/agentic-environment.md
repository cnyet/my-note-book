...
delegate_task(
  ...
  load_skills=[],
  prompt="Implement the user authentication logic based on the provided specifications..."
)
...
- **Sisyphus 工作流**: `docs/guides/sisyphus-workflow.md`
- **OpenCode 工作流**: `docs/guides/opencode-workflows.md`
- **OpenSpec 工作流**: `docs/guides/openspec-workflow.md`
