...
export default function Home() {
  return (
    <div className="min-h-screen pb-0 relative selection:bg-indigo-500 selection:text-white">
      ...
      {/* 主要内容区域 */}
      <div className="max-w-7xl mx-auto relative z-10 px-6 space-y-16 lg:space-y-24">
